...
#warning TODO: Implement BCard damage boosts, see Issue
            ...
            elementalDamage = (int)((elementalDamage + ((elementalDamage + baseDamage) * ((Session.Character.ElementRate  / 100D + 1) * (Session.Character.ElementRateSP / 100D + 1)))) * elementalBoost);
