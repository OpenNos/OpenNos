        ...
        private int[] GetMinilandMaxPoint(byte game)
        {
            ...
            switch (game)
            {
                case 0:
                    ...
                    break;
                case 1:
                    arr = new int[] { 999, 4999, 9999, 13999, 17999, 1000000 };
                    break;
                case 2:
                    arr = new int[] { 999, 3999, 7999, 14999, 24999, 1000000 };
                    break;
                case 3:
                    arr = new int[] { 999, 3999, 7999, 11999, 19999, 1000000 };
                    break;
                case 4:
                    arr = new int[] { 999, 4999, 7999, 11999, 15999, 1000000 };
                    break;
                case 5:
                    ...
                    break;
                default:
                    arr = new int[] { 999, 4999, 7999, 14999, 24999, 1000000 };
                    break;
            }
            return arr;
        }
