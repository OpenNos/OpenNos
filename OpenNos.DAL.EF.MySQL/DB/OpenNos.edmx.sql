...
-- -----------------------------------------------------------
-- Date Created: 04/22/2016 00:16:12
...
--    ALTER TABLE `quicklist` DROP CONSTRAINT `FK_CharacterQuicklistCharacter`;
...
CREATE TABLE `character`(
	...
	`HeroLvl` TINYINT UNSIGNED NOT NULL, 
...
CREATE TABLE `npcmonster`(
	...
	`XP` int NOT NULL, 
	`JobXP` int NOT NULL, 
	`IsHostile` bool NOT NULL, 
	`BasicSkill` smallint NOT NULL, 
	`BasicRange` TINYINT UNSIGNED NOT NULL, 
	`BasicArea` TINYINT UNSIGNED NOT NULL, 
